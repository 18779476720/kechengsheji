...
public class AprioriMyself {
    ...
    private static double MIN_SUPPROT = 0.3;//最小支持度百分比
    ...
    public static List<List<String>> getResult(List<List<String>> list){
...
//        MIN_CONFIDENCE = in.nextDouble();
        ...
        List<List<String>> resultLists = Apriori();//调用Apriori算法获得频繁项集
    ...
    //实现算法
    public static List<List<String>> Apriori() {
        ...
        //*****************************迭代过程**********************************
        times = 2;
        List<List<List<String>>> listFirst = new ArrayList<List<List<String>>>();
...
//                            listStrings.add("4");
//                        }
//                        listList.add(listStrings);
//                        System.out.print(list.get(j) + " ");
//                    }
//                    listFirst.add(listList);
//                    System.out.println();
//                }
//
//                for(int i = 0; i < listFirst.size(); i ++){
//                    for(int j = 0; j < listFirst.get(i).size(); j ++){
//                        System.out.println("开始：***********************");
//                        System.out.print(j + "：" + listFirst.get(i).get(j) + "    ");
